...
import com.juelunn.common.dto.*;
import com.juelunn.common.vo.*;
import com.juelunn.lightcloud.module.blog.dao.ArticleDao;
import com.juelunn.lightcloud.module.blog.dao.ArticleTagDao;
import com.juelunn.lightcloud.module.blog.dao.CategoryDao;
import com.juelunn.lightcloud.module.blog.dao.TagDao;
import com.juelunn.common.exception.BizException;
import com.juelunn.lightcloud.web.service.RedisService;
import com.juelunn.common.strategy.context.SearchStrategyContext;
import com.juelunn.common.util.UserUtils;
import com.juelunn.common.entity.Article;
import com.juelunn.common.entity.ArticleTag;
import com.juelunn.common.entity.Category;
import com.juelunn.common.entity.Tag;
import com.juelunn.lightcloud.module.blog.service.ArticleService;
import com.baomidou.mybatisplus.extension.service.impl.ServiceImpl;
import com.juelunn.lightcloud.module.blog.service.ArticleTagService;
...
import com.juelunn.common.enums.ArticleStatusEnum;
...
public class ArticleServiceImpl extends ServiceImpl<ArticleDao, Article> implements ArticleService {
    ...
    public PageResult<ArchiveDTO> listArchives() {
        ...
        Page<Article> articlePage = articleDao.selectPage(page, new LambdaQueryWrapper<Article>()
                .select(Article::getId, Article::getArticleTitle, Article::getCreateTime,Article::getCreateTime,Article::getArticleCover,Article::getArticleContent)
    ...
    public ArticlePreviewListDTO listArticlesByCondition(ConditionVO condition) {
        ...
        if (Objects.nonNull(condition.getCategoryId())) {
            name = categoryDao.selectOne(new LambdaQueryWrapper<Category>()
                    ...
                    .getCategoryName();
        } else if( Objects.nonNull(condition.getSort())){
            name = "热度排序";
        }else {
    ...
    public void saveArticleLike(Integer articleId) {
        // 判断是否点赞
        String articleLikeKey = RedisPrefixConst.ARTICLE_USER_LIKE + ((UserDetailDTO) UserUtils.getLoginUser()).getUserInfoId();
    ...
    public void saveOrUpdateArticle(ArticleVO articleVO) {
        ...
        article.setUserId(((UserDetailDTO)UserUtils.getLoginUser()).getUserInfoId());
