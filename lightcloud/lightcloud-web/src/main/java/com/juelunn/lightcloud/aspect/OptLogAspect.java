package com.juelunn.common.aspect;
...
public class OptLogAspect {
     ...
     */
    @Pointcut("@annotation(com.juelunn.common.annotation.OptLog)")
    ...
    public void saveOptLog(JoinPoint joinPoint, Object keys) {
        ...
        // 请求用户ID
        operationLog.setUserId(((UserDetailDTO)UserUtils.getLoginUser()).getId());
        // 请求用户
        operationLog.setNickname(((UserDetailDTO)UserUtils.getLoginUser()).getNickname());
        // 请求IP
