...
import com.juelunn.lightcloud.module.blog.dao.CommentDao;
...
import com.juelunn.lightcloud.module.blog.service.CommentService;
...
public class CommentServiceImpl extends ServiceImpl<CommentDao, Comment> implements CommentService {
    ...
    public void saveComment(CommentVO commentVO) {
        ...
        Comment comment = Comment.builder()
                .userId(((UserDetailDTO) UserUtils.getLoginUser()).getUserInfoId())
    ...
    public void saveCommentLike(Integer commentId) {
        // 判断是否点赞
        String commentLikeKey = RedisPrefixConst.COMMENT_USER_LIKE + ((UserDetailDTO)UserUtils.getLoginUser()).getUserInfoId();
