...
import com.juelunn.common.dto.UserAreaDTO;
...
import com.juelunn.common.enums.RoleEnum;
import com.juelunn.common.enums.UserAreaTypeEnum;
...
import com.juelunn.common.entity.UserInfo;
...
import com.juelunn.lightcloud.module.system.service.UserAuthService;
import com.baomidou.mybatisplus.extension.service.impl.ServiceImpl;
import com.juelunn.common.util.PageUtils;
import com.juelunn.lightcloud.web.service.RedisService;
import com.juelunn.common.strategy.context.SocialLoginStrategyContext;
...
public class UserAuthServiceImpl extends ServiceImpl<UserAuthDao, UserAuth> implements UserAuthService {
    ...
    public void updateAdminPassword(PasswordVO passwordVO) {
        ...
        UserAuth user = userAuthDao.selectOne(new LambdaQueryWrapper<UserAuth>()
                .eq(UserAuth::getId, ((UserDetailDTO) UserUtils.getLoginUser()).getId()));
        // 正确则修改密码，错误则提示不正确
