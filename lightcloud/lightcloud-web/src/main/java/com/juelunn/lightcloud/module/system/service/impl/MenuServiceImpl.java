...
import com.juelunn.lightcloud.module.system.dao.RoleMenuDao;
...
import com.juelunn.lightcloud.module.system.dao.MenuDao;
...
import com.juelunn.lightcloud.module.system.service.MenuService;
...
public class MenuServiceImpl extends ServiceImpl<MenuDao, Menu> implements MenuService {
    ...
    public List<UserMenuDTO> listUserMenus() {
        // 查询用户菜单信息
        List<Menu> menuList = menuDao.listMenusByUserInfoId(((UserDetailDTO) UserUtils.getLoginUser()).getUserInfoId());
        // 获取目录列表
        List<Menu> catalogList = listCatalog(menuList);
        // 获取目录下的子菜单
        Map<Integer, List<Menu>> childrenMap = getMenuMap(menuList);
