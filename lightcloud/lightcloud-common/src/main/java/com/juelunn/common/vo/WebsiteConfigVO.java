...
public class WebsiteConfigVO {
     ...
     * 版本
     */
    @ApiModelProperty(name = "version", value = "version", required = true, dataType = "String")
    private String version;

    /**
     * 下载地址
     */
    @ApiModelProperty(name = "downloadUrl", value = "downloadUrl", required = true, dataType = "String")
    private String downloadUrl;

    /**
     * 版本描述
     */
    @ApiModelProperty(name = "versionDesc", value = "versionDesc", required = true, dataType = "String")
